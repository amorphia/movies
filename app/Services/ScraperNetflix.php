...
class ScraperNetflix extends ScraperAbstract
{
    protected $client;
    protected $console;
    ...
    public function updateNetflixMovies()
    {
        ...
        if( $this->console ) $this->console->line( PHP_EOL . "Netflix Movies:" . PHP_EOL );
    ...
    public function moviesArray(){
        ...
        // load crawler
        $crawler = $this->client->request('GET', "https://www.movieinsider.com/c3899/netflix");
        $movies = [];
